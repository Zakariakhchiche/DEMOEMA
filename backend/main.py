...
# Clients externes — extraits dans backend/clients/ (audit ARCH-1)
# Aliases conservés pour compat avec les routes encore dans main.py.
from clients.google_news import PRESS_SIGNAL_KEYWORDS, get_google_news
from clients.infogreffe import INFOGREFFE_BASE, INFOGREFFE_DATASETS, get_infogreffe_actes
