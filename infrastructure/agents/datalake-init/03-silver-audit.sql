...
-- Tool-calling audit (codegen_tools.py) — chaque appel de tool LLM lors de la
-- génération du SQL est loggué ici en jsonb pour permettre l'analyse a
-- posteriori (combien d'introspect, quelles colonnes interrogées, dry_run OK?,
-- combien de retries pour ce silver…).
